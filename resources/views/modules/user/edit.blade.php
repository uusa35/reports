        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.edit', $element->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="civil_id" type="text"
                                           ...
                                           value="{{ $element->civil_id }}" required autocomplete="civil_id" autofocus>
                                    @error('civil_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    <img src="{{ $element->imageThumbLink }}" alt="" class="img-30">
                                </div>
                            </div>

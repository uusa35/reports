            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="col-2">{{ __('general.has_injuries') }}</th>
                        <th scope="col" class="col-2">{{ __('general.is_closed') }}</th>
                    ...
                    @if($elements->isNotEmpty())
                        @foreach($elements as $element)
                            <tr>
                                ...
                                <td><span
                                        class="alert alert-{{ $element->is_closed ? 'success' : 'secondary' }}"><small>{{ $element->is_closed ? __('general.has_injuries') : __('general.n_a') }}</small></span>
                                </td>
                                <td><img class="img-xxs" src="{{ $element->imageThumbLink }}"
                                         alt="{{ $element->notes }}"></td>
                                <td>{{ $element->area }}</td>

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('report.update', $element->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="text"
                                              ...
                                              name="description"
                                              value="{{ $element->description }}" required autocomplete="description"
                                              autofocus
                                              rows="5"
                                    ></textarea>
                            ...
                            <div class="form-group row">
                                <label for="name"
                                       class="col-md-4 col-form-label text-md-right text-danger">{{ __('general.closed') }}</label>
                                <div class="col-6 ">
                                    <div class="col">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="has_injuries"
                                                   id="inlineRadio1" value="1" {{ $element->is_closed ? 'checked' : '' }}>
                                            <label class="form-check-label"
                                                   for="inlineRadio1">{{ trans('general.closed') }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>

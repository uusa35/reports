...
return array(
    ...
    "submit" => "login",
    "password_instruction" => "must be no less than 8 letters and numbers",
    ...
    "primary_contributory" => "Type of the accident",
    "vehicle_plate_no" => "Vehicle Plate Number",
    "hit_and_run" => "hit and run",
    "run_over" => "run over",
    "anonynos" => "anonynos",
    "upload_up_to_six_images" => "You can upload up to 6 images only.",
    "upload_up_to_one_minute" => "You can upload up to 1 Minute.",
    "next" => "Next",
    "group_of_vehicles" => "group of vehicles",
    "hit_and_run" => "Hit and Run",
    "weather" => "weather",
